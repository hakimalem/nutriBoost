...
export const Footer = () => {
  return (
    <footer aria-label="Site Footer" className="bg-bg-green-light">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full">
                ...
                <div className=" border sm:flex sm:items-center sm:gap-4">
                  <input
                    type="email"
                    id="UserEmail"
                    placeholder="helsinki@rhcp.com"
                    className="w-full border-none border border-gray-100 p-2 focus:outline-none   sm:text-sm"
                  />
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-900 border-b border-primary pb-2 text-xl">
                About Nutriboost
              </p>

          ...
          <div className="flex-1 flex  sm:items-stretch  ">
              ...
              <div className="flex-col ">
                <div className="hidden sm:block sm:mx-6">
                  <div className="flex space-x-[6%] my-[2%] justify-center">
                    ...
                    <a className="text-gray-900 hover:bg-gray-700 active:bg-black hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                      Contacts
                    </a>
                    <a
                      href="#"
                    ...
                    >
                      <img className="h-[70%] w-auto" src={cart} alt="C" />
                    </a>
                  </div>
                  ...
                  <div className="rounded-md flex w-[400px] my-[2%]">
                    <input
                      type="text"
                      placeholder=" Search for Healthy Product"
                      in
                      className=" bg-slate-50 rounded-l-md flex w-full h-[30px] bg-dragos-iput text-sm font-medium focus:outline-none border border-dragos-input hover:border-primary hover:border-opacity-30 focus:border-primary"
                    />
                    <SearchButton />
                  </div>
                </div>
            ...
            <div className="flex items-start flex-col  flex-[1] ml-[1%] mr-[6%]">
              <div className="flex items-center justify-start flex-row  flex-[1] w-[100%] space-x-[5%]">
                ...
                >
                  <img className="h-[70%] w-auto" src={heart} alt="H" />
                </a>
                <button
                  type="button"
              ...
              <div className="flex items-center justify-start flex-row  flex-[1] w-[100%] space-x-[5%]">
                <a
                  ...
                  className="bg-green2 hover:bg-primary hover:bg-opacity-50 active:bg-opacity-60 active:bg-primary rounded-sm text-sm font-medium text-gray-700 h-[30px] w-[30px] flex justify-center items-center"
                >
                  <img className="h-[70%] w-auto" src={question} alt="Q" />
                </a>
                <button
                  type="button"
